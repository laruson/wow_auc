...
import com.gmail.chernikovich.wow_auctionator.presenter.utils.transform
...
class ItemViewModel : BaseViewModel<ItemRouter>() {
    ...
    val img = ObservableField<String>("https://wow.zamimg.com/images/wow/icons/large/inv_sword_04.jpg")
